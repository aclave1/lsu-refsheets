...
public class MainActivity extends ActionBarActivity
    ...
    private IRefSheetService refSheetService;

    public MainActivity(){
        super();
        refSheetService = new RefSheetService();
    }
     ...
     */
    public static class Frags extends Fragment {
        /**
         ...
         * number.
         */
        public static Frags newInstance(int sectionNumber) {
            Frags fragment = new Frags();
